...
<div class="max-w-7xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        ...
        <div>
            <a href="{{ route('admin.laporan.print', request()->query()) }}" target="_blank" class="px-4 py-2 bg-earth-brown hover:bg-earth-brown-dark text-white rounded-lg transition-colors text-sm font-medium inline-flex items-center gap-2">
