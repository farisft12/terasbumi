...
<head>
    ...
    <title>Login Admin - Teras Bumi Tour</title>
...
<body class="bg-cream min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-6">
            <div class="w-14 h-14 bg-earth-brown rounded-xl flex items-center justify-center mx-auto mb-3 shadow-md">
            ...
            <h1 class="text-xl font-bold text-earth-brown-dark">Teras Bumi Tour</h1>
            <p class="text-earth-brown text-sm">Login Admin</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md border border-cream-dark p-6">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="remember" id="remember" class="w-4 h-4 rounded border-cream-dark text-natural-green focus:ring-natural-green">
                    <label for="remember" class="ml-2 text-sm text-earth-brown">Ingat saya</label>
                </div>

                <button 
                    type="submit" 
                    class="w-full py-2.5 bg-earth-brown hover:bg-earth-brown-dark text-white font-medium rounded-lg transition-colors shadow-sm text-sm"
                >
                    Masuk
                </button>
            </form>
        ...
        <p class="text-center text-earth-brown-light text-xs mt-5">
            <a href="{{ url('/') }}" class="hover:text-natural-green transition-colors">← Kembali ke Beranda</a>
        </p>
    </div>
</body>
</html>
